...
export default function Post(props) {
  ...
  const description = function () {
    ...
    else return <>{props.description.slice(0, 100)}... <span className="text-[#6E6E6E]">more</span></>
  }()
    return (
      <>
        ...
        <div className="w-screen pb-6">
          ...
          <div className="flex w-screen px-3 py-[10px] items-center">
            ...
            {props.images.length > 1 && <div className="flex gap-[6px] items-center">{balls}</div>}
          ...
          <div className="flex flex-col gap-[6px] px-3">
              ...
              <div onClick={() => setOpen(!open)}>
                <span className="font-bold">{props.username}</span> {open ? props.description : description}
              </div>
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-[14px] items-center">
                  {props.emojis.map((e) => <div className='w-[14px] h-[14px]' key={props.emojis.indexOf(e)}><Emoji name={e.name} size='14' /></div>)}
